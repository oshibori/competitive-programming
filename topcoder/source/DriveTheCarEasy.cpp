...
public:
  long long calculateDistance(int S, int N, vector<int> speed_changes,
                              vector<int> moments) {

    long long ans = 0;
    vector<pair<long long, long long>> v;
    rep(i, 0, N) { v.push_back(make_pair(--moments[i], speed_changes[i])); }
    sort(all(v));
    ...
    rep(i, 0, v.size() - 1) {
      speed += v[i].second;
      ans += speed * (v[i + 1].first - v[i].first);
      dump(speed, ans);
    }
...
private:
  ...
  void test_case_0() {
    ...
    verify_case(0, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
  void test_case_1() {
    int Arg0 = 5;
    int Arg1 = 5;
    ...
    vector<int> Arg3(Arr3, Arr3 + (sizeof(Arr3) / sizeof(Arr3[0])));
    long long Arg4 = 35LL;
    verify_case(1, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
  void test_case_2() {
    int Arg0 = 100;
    int Arg1 = 5;
    ...
    vector<int> Arg3(Arr3, Arr3 + (sizeof(Arr3) / sizeof(Arr3[0])));
    long long Arg4 = 15LL;
    verify_case(2, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
  void test_case_3() {
    int Arg0 = 1000000000;
    int Arg1 = 3;
    ...
    verify_case(3, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
  void test_case_4() {
    int Arg0 = 100;
    int Arg1 = 10;
    ...
    verify_case(4, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
  void test_case_5() {
    int Arg0 = 1000000000;
    int Arg1 = 100;
    int Arr2[] = {857, 918, 679, 340, 868, 940, 593, 991, 355, 431, 757, 934,
                  676, 221, 922, 511, 467, 691, 835, 965, 221, 501, 325, 302,
                  896, 489, 607, 432, 968, 475, 84,  694, 354, 409, 643, 951,
                  420, 607, 167, 438, 986, 483, 806, 858, 553, 554, 325, 279,
                  327, 832, 200, 658, 992, 467, 958, 600, 473, 775, 770, 718,
                  807, 898, 530, 569, 384, 913, 315, 334, 392, 8,   962, 850,
                  61,  588, 980, 890, 747, 740, 469, 516, 7,   299, 163, 571,
                  455, 590, 427, 342, 239, 875, 258, 377, 428, 455, 653, 768,
                  307, 878, 368, 882};
    vector<int> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
    int Arr3[] = {
    ...
    verify_case(5, Arg4, calculateDistance(Arg0, Arg1, Arg2, Arg3));
  }
